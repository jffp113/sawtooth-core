...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='python/sawtooth_block_info/protobuf/batch.proto',
  package='',
  syntax='proto3',
  serialized_options=_b('\n\025sawtooth.sdk.protobufP\001Z\tbatch_pb2'),
  serialized_pb=_b('\n/python/sawtooth_block_info/protobuf/batch.proto\x1a\x35python/sawtooth_block_info/protobuf/transaction.proto\"[\n\x0b\x42\x61tchHeader\x12\x19\n\x11signer_public_key\x18\x01 \x01(\t\x12\x17\n\x0ftransaction_ids\x18\x02 \x03(\t\x12\x18\n\x10group_public_key\x18\x03 \x01(\x0c\"\x9d\x01\n\x05\x42\x61tch\x12\x0e\n\x06header\x18\x01 \x01(\x0c\x12\x18\n\x10header_signature\x18\x02 \x01(\t\x12\x17\n\x0fgroup_signature\x18\x05 \x01(\x0c\x12\x1e\n\x16group_signature_scheme\x18\x06 \x01(\t\x12\"\n\x0ctransactions\x18\x03 \x03(\x0b\x32\x0c.Transaction\x12\r\n\x05trace\x18\x04 \x01(\x08\"$\n\tBatchList\x12\x17\n\x07\x62\x61tches\x18\x01 \x03(\x0b\x32\x06.BatchB$\n\x15sawtooth.sdk.protobufP\x01Z\tbatch_pb2b\x06proto3')
  ,
  dependencies=[python_dot_sawtooth__block__info_dot_protobuf_dot_transaction__pb2.DESCRIPTOR,])
...
_BATCHHEADER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='group_public_key', full_name='BatchHeader.group_public_key', index=2,
...
_BATCH = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='group_signature', full_name='Batch.group_signature', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='group_signature_scheme', full_name='Batch.group_signature_scheme', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='transactions', full_name='Batch.transactions', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='trace', full_name='Batch.trace', index=5,
...
_BATCH.fields_by_name['transactions'].message_type = python_dot_sawtooth__block__info_dot_protobuf_dot_transaction__pb2._TRANSACTION
